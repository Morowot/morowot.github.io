...
{
token_id: '$(window.accountId)-cool-Tshirt',
metadata: {
title: "do you want this?",
description: "cool Tshirt",
media:
"https://bafybeid3luxioabgbt3rnajiy47lfd255lilbfmrzeoqnajdyhw5miomj4.ipfs.nftstorage.link/"
},
    ...
    <Card style={{ padding: "2vh" }}>
      <Container>
        <Row style={{ marginBottom: "2vh" }}>
          <p>
            Step 2: After you have logged in, hit this button to mint your "cool Tshirt" nft and go your{" "}
